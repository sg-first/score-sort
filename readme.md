...
```
 ...
 83.272  87.156  91.344  94.610  97.160  99.792 102.496 106.460 
```
我们取15%~85%这个区间，也就是成绩值为`[83.272, 106.46]`这个区间作为“不高不低”的分析对象，差不多是这部分：
![](Q3一阶段成绩~极差（画框）.png)
由于相关性比较显著，可以看出这段的极差区间约为`[137.5, 275]`